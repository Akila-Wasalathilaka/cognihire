...
export default function AdminDashboard() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const candidatesResponse = await fetch('/api/admin/candidates?limit=1');
      const candidatesData = await candidatesResponse.json();

      // Fetch assessments count
      const assessmentsResponse = await fetch('/api/admin/assessments?limit=1');
      const assessmentsData = await assessmentsResponse.json();

      // Fetch job roles count
      const jobRolesResponse = await fetch('/api/admin/job-roles?limit=1');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your cognitive assessment platform and monitor performance</p>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <button
                ...
                className="group bg-white hover:bg-gray-50 border border-gray-200 rounded-lg p-4 transition-colors hover:shadow-md"
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">Add, edit, and monitor candidates</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <h4 className="font-medium text-gray-900">Manage Job Roles</h4>
                    <p className="text-sm text-gray-500">Create and configure job roles</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">Monitor assessment progress</p>
                  </div>
                </div>
              </button>
            </div>
