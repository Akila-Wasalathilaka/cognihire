...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const loginResponse: LoginResponse = await api.login({ username, password });
      ...
      try {
        const profileData: User = await api.getProfile();
        ...
        // If profile fetch fails, redirect based on login response user data
